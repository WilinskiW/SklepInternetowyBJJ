...
<header class="main-panel">
    ...
    <div id="options">
        <div id="option_menu_userAccount" class="header_option">
            <span class="options-text">Twoje konto</span>
        </div>
        <div id="option_menu_shopping_cart" class="header_option">
            <span class="options-text">Koszyk</span>
        </div>
        <div id="option_menu_sell_product" class="header_option">
            <span class="options-text">Dodaj ogłoszenie</span>
        </div>
    </div>
    ...
    <nav id="products-block">
        <div id="men-products" class="product"><a class="category-href" href="">Mężczyźni</a></div>
        <div id="woman-products" class="product"><a class="category-href" href="">Kobiety</a></div>
        <div id="kid-products" class="product"><a class="category-href" href="">Dzieci</a></div>
    </nav>
</header>
<main>
    <a href=""><img src="jpg/bjj_kolekcja_red.jpg" alt="kolekcja: t-shirty 2024"></a>
